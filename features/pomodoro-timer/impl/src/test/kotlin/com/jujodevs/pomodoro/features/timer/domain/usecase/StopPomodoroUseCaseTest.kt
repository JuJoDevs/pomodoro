...
class StopPomodoroUseCaseTest {
    ...
    @Test
    fun `GIVEN running short break WHEN stopping THEN status should be idle and remaining reset`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN running long break WHEN stopping THEN remaining should use clamped long duration`() = runTest {
        // GIVEN
        repository.updateSessionState(
            PomodoroSessionState(
