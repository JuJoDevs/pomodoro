...
class UpdatePomodoroConfigUseCaseTest {
    ...
    @Test
    fun `GIVEN idle work phase WHEN updating work duration THEN selection and remaining should be updated`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN running work phase WHEN updating work duration THEN only selection should change`() = runTest {
        // GIVEN
        repository.updateSessionState(
            PomodoroSessionState(
    ...
    @Test
    fun `GIVEN idle short break WHEN updating duration THEN selection and remaining should update`() = runTest {
        // GIVEN
        repository.updateSessionState(
            PomodoroSessionState(
                status = PomodoroStatus.IDLE,
    ...
    @Test
    fun `GIVEN any state WHEN toggling auto start flags THEN values should be stored`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN warning snooze timestamp WHEN updating exact alarm warning snooze THEN value stored`() = runTest {
        // GIVEN
