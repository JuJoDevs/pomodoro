...
class AdvancePomodoroPhaseUseCaseTest {
    ...
    @Test
    fun `GIVEN a work session is finished WHEN advancing THEN phase should be short break`() =
        runTest {
            // GIVEN
    ...
    @Test
    fun `GIVEN 4 work sessions are finished WHEN advancing THEN phase should be long break`() =
        runTest {
            // GIVEN
            repository.updateSessionState(
                PomodoroSessionState(
    ...
    @Test
    fun `GIVEN long break is finished WHEN advancing THEN phase should be work and counter reset`() =
        runTest {
            // GIVEN
            repository.updateSessionState(
                PomodoroSessionState(
    ...
    @Test
    fun `GIVEN auto-start breaks is enabled WHEN advancing from work THEN status should be running`() =
        runTest {
            // GIVEN
            repository.updateSessionState(
                PomodoroSessionState(
