...
class StartOrResumePomodoroUseCaseTest {
    ...
    @Test
    fun `GIVEN idle state WHEN starting THEN status should be running with new token and end timestamp`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN paused state WHEN resuming THEN timer should continue from remaining millis`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN already running state WHEN invoking THEN state should remain unchanged`() = runTest {
        // GIVEN
