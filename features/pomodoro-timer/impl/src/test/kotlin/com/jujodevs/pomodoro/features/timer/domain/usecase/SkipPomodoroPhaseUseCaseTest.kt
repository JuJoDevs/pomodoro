...
class SkipPomodoroPhaseUseCaseTest {
    ...
    @Test
    fun `GIVEN first work session WHEN skipping THEN next phase should be short break`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN fourth work session WHEN skipping THEN next phase should be long break`() = runTest {
        // GIVEN
        repository.updateSessionState(
            PomodoroSessionState(
                currentPhase = PomodoroPhase.WORK,
    ...
    @Test
    fun `GIVEN long break phase WHEN skipping THEN progress should reset and return to work`() = runTest {
        // GIVEN
        repository.updateSessionState(
            PomodoroSessionState(
