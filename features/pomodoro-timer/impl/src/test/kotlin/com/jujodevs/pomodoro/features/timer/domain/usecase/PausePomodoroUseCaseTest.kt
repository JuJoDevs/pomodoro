...
class PausePomodoroUseCaseTest {
    ...
    @Test
    fun `GIVEN running session WHEN pausing THEN status should be paused and remaining recalculated`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN running session without end timestamp WHEN pausing THEN remaining should become zero`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN non running session WHEN pausing THEN state should remain unchanged`() = runTest {
        // GIVEN
        val initial = PomodoroSessionState(
