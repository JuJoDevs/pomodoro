...
sealed interface TimerAction {
    data class SelectWorkDuration(val minutes: Int) : TimerAction
    data class SelectShortBreakDuration(val minutes: Int) : TimerAction
    data class ToggleAutoStartBreaks(val enabled: Boolean) : TimerAction
    data class ToggleAutoStartWork(val enabled: Boolean) : TimerAction
    ...
    data class UpdateExactAlarmPermission(val isGranted: Boolean) : TimerAction
}
