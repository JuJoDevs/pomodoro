...
class NotificationSchedulerImplTest {
    ...
    @Test
    fun `GIVEN notification data WHEN scheduleNotification THEN should store notification`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN scheduled notification WHEN cancelNotification THEN should remove it`() = runTest {
        // GIVEN
        val notification = createTestNotification(id = 1)
    ...
    @Test
    fun `GIVEN multiple notifications WHEN cancelAllNotifications THEN should remove all`() = runTest {
        // GIVEN
    ...
    @Test
    fun `GIVEN scheduled notification WHEN isNotificationScheduled THEN should return true`() = runTest {
        // GIVEN
        val notification = createTestNotification(id = 1)
        scheduler.scheduleNotification(notification)
